...
No live Prometheus/K8s/flagd needed: score_events/verdict_for_type/
check_remediation only read a JSONL file and compare timestamps.
...
def test_normalize_events_healthy_load_watches_monitored_rule_ids():
    ...
    against to detect a false positive."""
    scenario = {
...
def test_committed_scenario_files_parse_and_normalize():
    """The 3 committed labeled-incident-set files must at least be
