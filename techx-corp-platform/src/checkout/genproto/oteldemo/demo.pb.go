...
type AskProductAIAssistantResponse struct {
	...
	CacheStatus       string                   `protobuf:"bytes,5,opt,name=cache_status,json=cacheStatus,proto3" json:"cache_status,omitempty"`
	Similarity        float32                  `protobuf:"fixed32,6,opt,name=similarity,proto3" json:"similarity,omitempty"`
	SourceFingerprint string                   `protobuf:"bytes,7,opt,name=source_fingerprint,json=sourceFingerprint,proto3" json:"source_fingerprint,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *AskProductAIAssistantResponse) GetCacheStatus() string {
	if x != nil {
...
func (x *AskProductAIAssistantResponse) GetSimilarity() float32 {
	if x != nil {
		return x.Similarity
	}
	return 0
...
func (x *AskProductAIAssistantResponse) GetSourceFingerprint() string {
	if x != nil {
...
type ValidatePaymentRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CreditCard    *CreditCardInfo        `protobuf:"bytes,1,opt,name=credit_card,json=creditCard,proto3" json:"credit_card,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidatePaymentRequest) GetCreditCard() *CreditCardInfo {
	if x != nil {
		return x.CreditCard
	}
	return nil
...
func (x *ValidatePaymentResponse) GetPaymentToken() string {
	if x != nil {
...
func (x *ValidatePaymentResponse) GetCardLastFour() string {
	if x != nil {
...
type OrderResult struct {
	...
	TotalOrderCost  *Money                 `protobuf:"bytes,2,opt,name=total_order_cost,json=totalOrderCost,proto3" json:"total_order_cost,omitempty"`
...
func (x *OrderResult) GetTotalOrderCost() *Money {
	if x != nil {
		return x.TotalOrderCost
	}
	return nil
}
...
type PaymentSummary struct {
	...
	CardLastFour  string                 `protobuf:"bytes,2,opt,name=card_last_four,json=cardLastFour,proto3" json:"card_last_four,omitempty"`
...
func (x *PaymentSummary) GetPaymentToken() string {
	if x != nil {
		return x.PaymentToken
	}
	return ""
...
func (x *PaymentSummary) GetCardLastFour() string {
	if x != nil {
		return x.CardLastFour
	}
	return ""
...
func (x *PaymentSummary) GetCardType() string {
	if x != nil {
		return x.CardType
	}
	return ""
...
func (x *PaymentSummary) GetTotalAmount() *Money {
	if x != nil {
...
type OrderEvent struct {
	...
	OrderResult    *OrderResult           `protobuf:"bytes,3,opt,name=order_result,json=orderResult,proto3" json:"order_result,omitempty"`
	PaymentSummary *PaymentSummary        `protobuf:"bytes,4,opt,name=payment_summary,json=paymentSummary,proto3" json:"payment_summary,omitempty"`
...
func (x *OrderEvent) GetOrderResult() *OrderResult {
	if x != nil {
...
func (x *OrderEvent) GetPaymentSummary() *PaymentSummary {
	if x != nil {
...
type PaymentEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EventType     string                 `protobuf:"bytes,1,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"` // "PAYMENT_COMPLETED"
	Source        string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"`                        // "payment"
	OrderId       string                 `protobuf:"bytes,3,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	UserId        string                 `protobuf:"bytes,4,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	OrderResult   *OrderResult           `protobuf:"bytes,5,opt,name=order_result,json=orderResult,proto3" json:"order_result,omitempty"`
...
func (x *PaymentEvent) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *PaymentEvent) GetOrderResult() *OrderResult {
	if x != nil {
		return x.OrderResult
	}
	return nil
...
type ShippingEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EventType     string                 `protobuf:"bytes,1,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"` // "SHIPPING_COMPLETED"
	Source        string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"`                        // "shipping"
	OrderId       string                 `protobuf:"bytes,3,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	UserId        string                 `protobuf:"bytes,4,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	OrderResult   *OrderResult           `protobuf:"bytes,5,opt,name=order_result,json=orderResult,proto3" json:"order_result,omitempty"`
	Timestamp     string                 `protobuf:"bytes,6,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
...
func (x *ShippingEvent) GetEventType() string {
	if x != nil {
		return x.EventType
	}
	return ""
...
func (x *ShippingEvent) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *ShippingEvent) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ShippingEvent) GetOrderResult() *OrderResult {
	if x != nil {
		return x.OrderResult
	}
	return nil
...
func (x *ShippingEvent) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
const file_demo_proto_rawDesc = "" +
	...
	"\x06detail\x18\x04 \x01(\tR\x06detail\"\xbd\x02\n" +
	...
	"traceSteps\x12!\n" +
	"\fcache_status\x18\x05 \x01(\tR\vcacheStatus\x12\x1e\n" +
	"\n" +
	"similarity\x18\x06 \x01(\x02R\n" +
	"similarity\x12-\n" +
	"\x12source_fingerprint\x18\a \x01(\tR\x11sourceFingerprint\"h\n" +
	...
	"\x16ValidatePaymentRequest\x129\n" +
	"\vcredit_card\x18\x01 \x01(\v2\x18.oteldemo.CreditCardInfoR\n" +
	"creditCard\"\x94\x01\n" +
	"\x17ValidatePaymentResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12#\n" +
	"\rpayment_token\x18\x03 \x01(\tR\fpaymentToken\x12$\n" +
	"\x0ecard_last_four\x18\x04 \x01(\tR\fcardLastFour\"s\n" +
	"\rChargeRequest\x12'\n" +
	...
	"\x04cost\x18\x02 \x01(\v2\x0f.oteldemo.MoneyR\x04cost\"\xcc\x01\n" +
	"\vOrderResult\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\x129\n" +
	"\x10total_order_cost\x18\x02 \x01(\v2\x0f.oteldemo.MoneyR\x0etotalOrderCost\x12<\n" +
	"\x10shipping_address\x18\x03 \x01(\v2\x11.oteldemo.AddressR\x0fshippingAddress\x12)\n" +
	"\x05items\x18\x04 \x03(\v2\x13.oteldemo.OrderItemR\x05items\"a\n" +
	...
	"\x12DeleteFlagResponse\"\xac\x01\n" +
	"\x0ePaymentSummary\x12#\n" +
	"\rpayment_token\x18\x01 \x01(\tR\fpaymentToken\x12$\n" +
	"\x0ecard_last_four\x18\x02 \x01(\tR\fcardLastFour\x12\x1b\n" +
	"\tcard_type\x18\x03 \x01(\tR\bcardType\x122\n" +
	"\ftotal_amount\x18\x04 \x01(\v2\x0f.oteldemo.MoneyR\vtotalAmount\"\xdb\x01\n" +
	"\n" +
	"OrderEvent\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x128\n" +
	"\forder_result\x18\x03 \x01(\v2\x15.oteldemo.OrderResultR\vorderResult\x12A\n" +
	"\x0fpayment_summary\x18\x04 \x01(\v2\x18.oteldemo.PaymentSummaryR\x0epaymentSummary\x12\x1c\n" +
	"\ttimestamp\x18\x05 \x01(\tR\ttimestamp\"\xd1\x01\n" +
	...
	"\forder_result\x18\x05 \x01(\v2\x15.oteldemo.OrderResultR\vorderResult\x12\x1c\n" +
	"\ttimestamp\x18\x06 \x01(\tR\ttimestamp\"\xd2\x01\n" +
	"\rShippingEvent\x12\x1d\n" +
	"\n" +
	"event_type\x18\x01 \x01(\tR\teventType\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12\x19\n" +
	"\border_id\x18\x03 \x01(\tR\aorderId\x12\x17\n" +
	"\auser_id\x18\x04 \x01(\tR\x06userId\x128\n" +
	"\forder_result\x18\x05 \x01(\v2\x15.oteldemo.OrderResultR\vorderResult\x12\x1c\n" +
	"\ttimestamp\x18\x06 \x01(\tR\ttimestamp2\xf9\x01\n" +
	"\vCartService\x126\n" +
	...
	"\aConvert\x12#.oteldemo.CurrencyConversionRequest\x1a\x0f.oteldemo.Money\"\x002\xa2\x01\n" +
	"\x0ePaymentService\x12=\n" +
	"\x06Charge\x12\x17.oteldemo.ChargeRequest\x1a\x18.oteldemo.ChargeResponse\"\x00\x12Q\n" +
	"\bValidate\x12 .oteldemo.ValidatePaymentRequest\x1a!.oteldemo.ValidatePaymentResponse\"\x002b\n" +
	"\fEmailService\x12R\n" +
...
var file_demo_proto_goTypes = []any{
	...
	(*ValidatePaymentRequest)(nil),               // 31: oteldemo.ValidatePaymentRequest
	(*ValidatePaymentResponse)(nil),              // 32: oteldemo.ValidatePaymentResponse
	...
	(*PaymentSummary)(nil),                       // 54: oteldemo.PaymentSummary
	(*OrderEvent)(nil),                           // 55: oteldemo.OrderEvent
	(*PaymentEvent)(nil),                         // 56: oteldemo.PaymentEvent
	(*ShippingEvent)(nil),                        // 57: oteldemo.ShippingEvent
}
var file_demo_proto_depIdxs = []int32{
	...
	30, // 14: oteldemo.ValidatePaymentRequest.credit_card:type_name -> oteldemo.CreditCardInfo
	27, // 15: oteldemo.ChargeRequest.amount:type_name -> oteldemo.Money
	30, // 16: oteldemo.ChargeRequest.credit_card:type_name -> oteldemo.CreditCardInfo
	0,  // 17: oteldemo.OrderItem.item:type_name -> oteldemo.CartItem
	27, // 18: oteldemo.OrderItem.cost:type_name -> oteldemo.Money
	27, // 19: oteldemo.OrderResult.total_order_cost:type_name -> oteldemo.Money
	...
	30, // 24: oteldemo.PlaceOrderRequest.credit_card:type_name -> oteldemo.CreditCardInfo
	...
	27, // 30: oteldemo.PaymentSummary.total_amount:type_name -> oteldemo.Money
	36, // 31: oteldemo.OrderEvent.order_result:type_name -> oteldemo.OrderResult
	54, // 32: oteldemo.OrderEvent.payment_summary:type_name -> oteldemo.PaymentSummary
	36, // 33: oteldemo.PaymentEvent.order_result:type_name -> oteldemo.OrderResult
	36, // 34: oteldemo.ShippingEvent.order_result:type_name -> oteldemo.OrderResult
	1,  // 35: oteldemo.CartService.AddItem:input_type -> oteldemo.AddItemRequest
	1,  // 36: oteldemo.CartService.AddItemAndGetCart:input_type -> oteldemo.AddItemRequest
	3,  // 37: oteldemo.CartService.GetCart:input_type -> oteldemo.GetCartRequest
	2,  // 38: oteldemo.CartService.EmptyCart:input_type -> oteldemo.EmptyCartRequest
	6,  // 39: oteldemo.RecommendationService.ListRecommendations:input_type -> oteldemo.ListRecommendationsRequest
	5,  // 40: oteldemo.ProductCatalogService.ListProducts:input_type -> oteldemo.Empty
	10, // 41: oteldemo.ProductCatalogService.GetProduct:input_type -> oteldemo.GetProductRequest
	11, // 42: oteldemo.ProductCatalogService.SearchProducts:input_type -> oteldemo.SearchProductsRequest
	14, // 43: oteldemo.ProductReviewService.GetProductReviews:input_type -> oteldemo.GetProductReviewsRequest
	16, // 44: oteldemo.ProductReviewService.GetAverageProductReviewScore:input_type -> oteldemo.GetAverageProductReviewScoreRequest
	18, // 45: oteldemo.ProductReviewService.AskProductAIAssistant:input_type -> oteldemo.AskProductAIAssistantRequest
	22, // 46: oteldemo.ShippingService.GetQuote:input_type -> oteldemo.GetQuoteRequest
	24, // 47: oteldemo.ShippingService.ShipOrder:input_type -> oteldemo.ShipOrderRequest
	5,  // 48: oteldemo.CurrencyService.GetSupportedCurrencies:input_type -> oteldemo.Empty
	29, // 49: oteldemo.CurrencyService.Convert:input_type -> oteldemo.CurrencyConversionRequest
	33, // 50: oteldemo.PaymentService.Charge:input_type -> oteldemo.ChargeRequest
	31, // 51: oteldemo.PaymentService.Validate:input_type -> oteldemo.ValidatePaymentRequest
	37, // 52: oteldemo.EmailService.SendOrderConfirmation:input_type -> oteldemo.SendOrderConfirmationRequest
	38, // 53: oteldemo.CheckoutService.PlaceOrder:input_type -> oteldemo.PlaceOrderRequest
	40, // 54: oteldemo.AdService.GetAds:input_type -> oteldemo.AdRequest
	44, // 55: oteldemo.FeatureFlagService.GetFlag:input_type -> oteldemo.GetFlagRequest
	46, // 56: oteldemo.FeatureFlagService.CreateFlag:input_type -> oteldemo.CreateFlagRequest
	48, // 57: oteldemo.FeatureFlagService.UpdateFlag:input_type -> oteldemo.UpdateFlagRequest
	50, // 58: oteldemo.FeatureFlagService.ListFlags:input_type -> oteldemo.ListFlagsRequest
	52, // 59: oteldemo.FeatureFlagService.DeleteFlag:input_type -> oteldemo.DeleteFlagRequest
	5,  // 60: oteldemo.CartService.AddItem:output_type -> oteldemo.Empty
	4,  // 61: oteldemo.CartService.AddItemAndGetCart:output_type -> oteldemo.Cart
	4,  // 62: oteldemo.CartService.GetCart:output_type -> oteldemo.Cart
	5,  // 63: oteldemo.CartService.EmptyCart:output_type -> oteldemo.Empty
	7,  // 64: oteldemo.RecommendationService.ListRecommendations:output_type -> oteldemo.ListRecommendationsResponse
	9,  // 65: oteldemo.ProductCatalogService.ListProducts:output_type -> oteldemo.ListProductsResponse
	8,  // 66: oteldemo.ProductCatalogService.GetProduct:output_type -> oteldemo.Product
	12, // 67: oteldemo.ProductCatalogService.SearchProducts:output_type -> oteldemo.SearchProductsResponse
	15, // 68: oteldemo.ProductReviewService.GetProductReviews:output_type -> oteldemo.GetProductReviewsResponse
	17, // 69: oteldemo.ProductReviewService.GetAverageProductReviewScore:output_type -> oteldemo.GetAverageProductReviewScoreResponse
	21, // 70: oteldemo.ProductReviewService.AskProductAIAssistant:output_type -> oteldemo.AskProductAIAssistantResponse
	23, // 71: oteldemo.ShippingService.GetQuote:output_type -> oteldemo.GetQuoteResponse
	25, // 72: oteldemo.ShippingService.ShipOrder:output_type -> oteldemo.ShipOrderResponse
	28, // 73: oteldemo.CurrencyService.GetSupportedCurrencies:output_type -> oteldemo.GetSupportedCurrenciesResponse
	27, // 74: oteldemo.CurrencyService.Convert:output_type -> oteldemo.Money
	34, // 75: oteldemo.PaymentService.Charge:output_type -> oteldemo.ChargeResponse
	32, // 76: oteldemo.PaymentService.Validate:output_type -> oteldemo.ValidatePaymentResponse
	5,  // 77: oteldemo.EmailService.SendOrderConfirmation:output_type -> oteldemo.Empty
	39, // 78: oteldemo.CheckoutService.PlaceOrder:output_type -> oteldemo.PlaceOrderResponse
	41, // 79: oteldemo.AdService.GetAds:output_type -> oteldemo.AdResponse
	45, // 80: oteldemo.FeatureFlagService.GetFlag:output_type -> oteldemo.GetFlagResponse
	47, // 81: oteldemo.FeatureFlagService.CreateFlag:output_type -> oteldemo.CreateFlagResponse
	49, // 82: oteldemo.FeatureFlagService.UpdateFlag:output_type -> oteldemo.UpdateFlagResponse
	51, // 83: oteldemo.FeatureFlagService.ListFlags:output_type -> oteldemo.ListFlagsResponse
	53, // 84: oteldemo.FeatureFlagService.DeleteFlag:output_type -> oteldemo.DeleteFlagResponse
