...
export interface ProductReviewCitation {
  reviewId: string;
  snippet: string;
  score: string;
}
...
function createBaseProductReviewCitation(): ProductReviewCitation {
  return { reviewId: "", snippet: "", score: "" };
}

export const ProductReviewCitation: MessageFns<ProductReviewCitation> = {
  encode(message: ProductReviewCitation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reviewId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProductReviewCitation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseProductReviewCitation();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ProductReviewCitation {
    return {
  ...
  toJSON(message: ProductReviewCitation): unknown {
    const obj: any = {};
    if (message.reviewId !== "") {
  ...
  create<I extends Exact<DeepPartial<ProductReviewCitation>, I>>(base?: I): ProductReviewCitation {
    return ProductReviewCitation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProductReviewCitation>, I>>(object: I): ProductReviewCitation {
    const message = createBaseProductReviewCitation();
...
function createBaseTraceStep(): TraceStep {
  return { stepName: "", latencyMs: 0, status: "", detail: "" };
}
...
export const AskProductAIAssistantResponse: MessageFns<AskProductAIAssistantResponse> = {
  encode(message: AskProductAIAssistantResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cacheStatus !== "") {
      writer.uint32(42).string(message.cacheStatus);
    }
    if (message.similarity !== 0) {
      writer.uint32(53).float(message.similarity);
    }
    if (message.sourceFingerprint !== "") {
      writer.uint32(58).string(message.sourceFingerprint);
    }
    return writer;
  },
...
function createBaseValidatePaymentRequest(): ValidatePaymentRequest {
  return { creditCard: undefined };
}

export const ValidatePaymentRequest: MessageFns<ValidatePaymentRequest> = {
  encode(message: ValidatePaymentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creditCard !== undefined) {
      CreditCardInfo.encode(message.creditCard, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ValidatePaymentRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseValidatePaymentRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ValidatePaymentRequest {
    return { creditCard: isSet(object.creditCard) ? CreditCardInfo.fromJSON(object.creditCard) : undefined };
  },

  toJSON(message: ValidatePaymentRequest): unknown {
    const obj: any = {};
    if (message.creditCard !== undefined) {
  ...
  create<I extends Exact<DeepPartial<ValidatePaymentRequest>, I>>(base?: I): ValidatePaymentRequest {
    return ValidatePaymentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatePaymentRequest>, I>>(object: I): ValidatePaymentRequest {
    const message = createBaseValidatePaymentRequest();
...
function createBaseValidatePaymentResponse(): ValidatePaymentResponse {
  return { valid: false, message: "" };
}

export const ValidatePaymentResponse: MessageFns<ValidatePaymentResponse> = {
  encode(message: ValidatePaymentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidatePaymentResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseValidatePaymentResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ValidatePaymentResponse {
    return {
  ...
  toJSON(message: ValidatePaymentResponse): unknown {
    const obj: any = {};
    if (message.valid !== false) {
  ...
  create<I extends Exact<DeepPartial<ValidatePaymentResponse>, I>>(base?: I): ValidatePaymentResponse {
    return ValidatePaymentResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatePaymentResponse>, I>>(object: I): ValidatePaymentResponse {
    const message = createBaseValidatePaymentResponse();
...
export const PaymentServiceService = {
  ...
  validate: {
    path: "/oteldemo.PaymentService/Validate",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ValidatePaymentRequest): Buffer =>
      Buffer.from(ValidatePaymentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ValidatePaymentRequest => ValidatePaymentRequest.decode(value),
    responseSerialize: (value: ValidatePaymentResponse): Buffer =>
      Buffer.from(ValidatePaymentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ValidatePaymentResponse => ValidatePaymentResponse.decode(value),
  },
} as const;
...
export interface PaymentServiceServer extends UntypedServiceImplementation {
  ...
  validate: handleUnaryCall<ValidatePaymentRequest, ValidatePaymentResponse>;
}
...
export interface PaymentServiceClient extends Client {
  ...
  validate(
    ...
    callback: (error: ServiceError | null, response: ValidatePaymentResponse) => void,
  ): ClientUnaryCall;
  validate(
    request: ValidatePaymentRequest,
    metadata: Metadata,
