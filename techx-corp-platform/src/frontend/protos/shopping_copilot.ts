...
export interface ChatWithCopilotResponse {
  ...
  /** Trạng thái cache: hit_exact, hit_semantic, miss, bypass */
  cacheStatus: string;
  /** Độ tương đồng (nếu hit_semantic) */
  similarity: number;
  /** Fingerprint của nguồn dữ liệu tạo nên cache */
...
export const ChatWithCopilotResponse: MessageFns<ChatWithCopilotResponse> = {
  encode(message: ChatWithCopilotResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.similarity !== 0) {
      writer.uint32(77).float(message.similarity);
    }
    if (message.sourceFingerprint !== "") {
      writer.uint32(82).string(message.sourceFingerprint);
    }
    return writer;
  },
  ...
  fromJSON(object: any): ChatWithCopilotResponse {
    return {
      ...
      sourceFingerprint: isSet(object.sourceFingerprint) ? globalThis.String(object.sourceFingerprint) : "",
    };
  },
  ...
  toJSON(message: ChatWithCopilotResponse): unknown {
    ...
    if (message.sourceFingerprint !== "") {
      obj.sourceFingerprint = message.sourceFingerprint;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ChatWithCopilotResponse>, I>>(object: I): ChatWithCopilotResponse {
    ...
    message.sourceFingerprint = object.sourceFingerprint ?? "";
    return message;
  },
};
