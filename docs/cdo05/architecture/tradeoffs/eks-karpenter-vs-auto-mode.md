...
Nhóm sẽ xem xét lại quyết định nếu không có owner rõ ràng cho platform operations, workload không fit với Karpenter policy, hoặc chi phí vận hành Karpenter cao hơn lợi ích cost/control nhận được.
...
Fallback gần nhất là **Managed Node Groups** nếu Karpenter làm phase này chậm lại quá nhiều hoặc team chưa đủ owner vận hành.
