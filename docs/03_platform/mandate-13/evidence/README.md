...
| **#5** node-hours ↓≥30%, spot≥50%, **Graviton**, co xuống thật, SLO giữ | ❌ **KHÔNG đạt node-hours** (0% chênh lệch trên pool `default`) — spot ratio 63.9% ✅ đạt, Graviton ❌ deferred có chủ ý | Xem ADR Decision 4 cho lý do defer Graviton | `EVIDENCE.md` #3 |
