...
- **Quyết định:** 
  ...
  - **Chiến lược làm mới cache (Dynamic TTL + Version Key):**
    1. **TTL cache** ~~động 4h–7d~~ → **[amended 12/07] phẳng 7 ngày.** Thiết kế gốc tính TTL động theo $N$/$\sigma^2$; đã gỡ khỏi code vì review data tĩnh (không rpc ghi — verified) nên $N$/$\sigma^2$ không đổi, công thức không phản ứng với gì. Xem Phụ lục kiểm chứng.
