...
- Realtime streaming (consumer Kafka/subscription) thêm hạ tầng phải vận hành + tải OpenSearch, đổi lấy ≤30s — sai trade-off với BUDGET.md và team 10 người.
