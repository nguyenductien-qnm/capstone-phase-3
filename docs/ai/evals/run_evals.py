...
if __name__ == "__main__":
    ...
    default_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "golden_dataset.json")
    parser.add_argument("--dataset", type=str, default=default_path, help="Path to golden dataset file")
