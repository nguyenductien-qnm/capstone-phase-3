...
Do Shopping Copilot chạy thêm Phase-2 Local ML Guard (ProtectAI DeBERTa ~738MB + Presidio/SpaCy ~400MB) khi `LLM_LOCAL_ML_GUARD=true`, cấu hình tài nguyên được thống nhất tăng lên như sau:
